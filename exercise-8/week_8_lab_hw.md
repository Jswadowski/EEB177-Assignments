...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-1-1.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-2-1.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-3-1.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-4-1.png) \#
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-5-1.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-5-2.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-5-3.png)

    p1 + 
      geom_text(aes(label=State), size = 3)

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-5-4.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-5-5.png)

    p1 +
      geom_point(aes(size = 2),# incorrect! 2 is not a variable
                 color="red") # this is fine -- all points red

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-5-6.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-5-7.png) \#
Exercise 1
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-6-1.png)

    ggplot(dat, aes(x = CPI, y = HDI)) + geom_point()

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-6-2.png)

    ggplot(dat, aes(x = CPI, y = HDI), color="blue") + geom_point()

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-6-3.png)

    ggplot(dat, aes(x = CPI, y = HDI, size = HDI.Rank, color=Region)) + geom_point()

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-6-4.png) \#
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-7-1.png)

    #with changed bin value
    p2 + geom_histogram(stat = "bin", binwidth=4000)

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-7-2.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-7-3.png) \#
Exercise 2
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-8-1.png)

    ggplot(dat, aes(x = CPI, y = HDI))+ geom_point() + geom_smooth()

    ## `geom_smooth()` using method = 'loess'

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-8-2.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-8-3.png)

    ggplot(dat, aes(x = CPI, y = HDI))+ geom_point() + geom_smooth(span = .2)

    ## `geom_smooth()` using method = 'loess'

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-8-4.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-9-1.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-9-2.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-9-3.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-9-4.png)
\#\# Exercise 3
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-10-1.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-10-2.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-10-3.png)
\#\# Faceting

    p5 <- ggplot(housing, aes(x = Date, y = Home.Value))
    p5 + geom_line(aes(color = State)) #produces obscure lines

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-11-1.png)

    (p5 <- p5 + geom_line() +
       facet_wrap(~State, ncol = 10))

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-11-2.png)
\#\# Themes

    p5 + theme_linedraw()

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-12-1.png)

    p5 + theme_light()

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-12-2.png)

    p5 + theme_minimal() +
      theme(text = element_text(color = "turquoise"))

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-12-3.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-12-4.png)
\#\# Best way to plot a data.frame of two variables as separate points
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-13-1.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-13-2.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-14-1.png)

    (second <- first + geom_smooth(aes(group = 1), method = "lm", formula = y ~ log(x), se = FALSE, color = "red")) + geom_point()

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-14-2.png)

    (third <- second + geom_point(size = 1, shape = 1) + geom_point(size = 1, shape = 1) + geom_point(size = 1, shape = 1))

![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-14-3.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-14-4.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-14-5.png)
...
![](week_8_lab_hw_files/figure-markdown_strict/unnamed-chunk-14-6.png)
